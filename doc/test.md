# Mac Super Assistant（Assistant）MVP 测试方案
...
- 手动验收记录：本次后台子 Agent 无法可靠操作真实菜单栏、系统权限弹窗、全局快捷键、屏幕录制授权、辅助功能授权、真实截图捕获、邮件客户端和浏览器页面；未虚构人工结果。相关 P0/P1 手动项仍按本文件第 5/6/7 节在 release-candidate 环境执行。
