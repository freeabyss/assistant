...
|------|------|-------|-----|------|---------|------|------|
| v1.2.1 | 欢迎页面路由 bug + 关闭按钮 | #7 | - | in_progress | ⑤ XCUITest 扩展代码就绪（待 GUI 授权跑通） | 2026-07-07 | - |
...
## v1.2.0（已上线）
- 目标：正式确立产品名「青鸟 / Qingniao」并全面改名（工程、target、源码目录、显示名、文案）；从①需求→②产品→③架构→④评审全流程重新审视现有产品不足，直接修订 doc/ 全局文件
